...
import { Filter, QualityReport, HourlyStatsTable, FrequentDefectsTable, EfficiencyChart, KeyStatsTable, HourlyProductionTable } from "../../components";
	...
	render() {
		...
		return (
			<div className={styles.block}>
					<Filter filterDate={this.state.filterDateTime} handleFilterDateChange={this.handleFilterDateChange} />
					...
					<div className={styles['detail-cards-cont']}>
						{/* <ProductionOrdersProgress filterDate={this.state.filterDate} /> */}
						<EfficiencyChart filterDateTime={filterDateTime} />
